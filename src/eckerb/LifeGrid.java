...
public class LifeGrid {
    ...
    /**
     * gets the number of cells wide
     * of the LifeGrid.
     *
     * @return The private int, numberOfCellsWide.
     */
    public int getNumberOfCellsWide() {
        return this.numberOfCellsWide;
    }

    /**
     * gets the number of cells high
     * of the LifeGrid.
     *
     * @return The private int, numberOfCellsHigh.
     */
    public int getNumberOfCellsHigh() {
        return this.numberOfCellsHigh;
    }

    /**
     * gets the list of list of cells
     * created bu the LifeGrid.
     *
     * @return The private List<Lists<Cells>>.
     */
